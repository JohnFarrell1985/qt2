...
class TestFinancialDownload:
    ...
    def test_download_financial_data(self, qmt_client):
    ...
    def test_download_financial_data2(self, qmt_client):
...
class TestFinancialRead:
    ...
    def test_balance_sheet(self, qmt_client):
    ...
    def test_income_statement(self, qmt_client):
    ...
    def test_pershareindex(self, qmt_client):
    ...
    def test_multi_table_read(self, qmt_client):
        """TC-F-06: 同时获取多张表"""

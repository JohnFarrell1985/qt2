...
| [**市场情绪引擎**](doc/11-市场情绪引擎.md) | **情绪特征工程、合成指数、宏观状态分类、策略参数Profile** |
| [**数据采集模块**](doc/12-数据采集模块.md) | **五层采集架构、反爬体系 (curl_cffi)、APScheduler 调度** |
| [**数据清洗与LLM**](doc/13-数据清洗与LLM.md) | **LLM 清洗管道、Schema 注册表、多引擎复用、降级策略** |
| [**TODO 待办清单**](doc/TODO.md) | **69 项待办: Bug 修复、新模块开发、量化体系优化, P0-P3 分级** |
